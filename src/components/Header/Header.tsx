...
const Header: React.FC<HeaderProps> = () => {
  const rightPadding = 360; // Adjust this value as needed
  return (
    <header
      style={{ width: `calc(100vw - ${rightPadding}px)` }}
      className="flex h-[77px] w-screen items-center justify-between px-4 py-2 bg-white"
    >
      <div className="flex items-center space-x-4">
        <div className="relative">
          <input
            type="text"
            className="pl-9 pr-10 py-2 w-[441px] h-[41.89px] rounded-lg bg-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="Search"
