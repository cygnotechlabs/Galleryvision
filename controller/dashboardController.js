...
//         const currentDashboardData = await dashboard.findOne({ date: currentDate });
//         const prevDashboardData = await dashboard.findOne({ date: prevDate });

//         // Prepare response object
//         const responseObject = {
//             currentDashboardData,
//             currentAsset: 0, // Initialize currentAsset as 0 by default
//         };

//         // Calculate total assets if currentDashboardData exists
//         if (currentDashboardData) {
//             responseObject.currentAsset = parseInt(currentDashboardData.totalChannel)+ parseFloat(currentDashboardData.totalMusic);
//         } else {
//             return res.status(404).json({ message: "No dashboard details found for the current date" });
//         }

//         // Calculate percentage changes if prevDashboardData exists
//         if (prevDashboardData) {
//             const prevAsset = parseInt(prevDashboardData.totalChannel) + parseInt(prevDashboardData.totalMusic);
...
//                 totalAsset: calculatePercentageChange(responseObject.currentAsset, prevAsset).toFixed(1),
...
//         // Fetch the dashboard data sorted by date
...
//         const prevDashboardData = currentDashboardIndex > 0 ? dashboards[currentDashboardIndex - 1] : null;

//         // Calculate total assets
//         const currentAsset = parseInt(currentDashboardData.totalChannel || 0) + parseInt(currentDashboardData.totalMusic || 0);
